...
pickle.dump(result.x, open("ITA_Bulk_Mu_R_Opt2.p", "wb"))

result.x = pickle.load(open("ITA_Bulk_Mu_R_Opt2.p", "rb"))
...
for iter in range(20):
    ...
    # pickle.dump(sample_inf, open("ITA_sample_inf2_"+str(iter)+".p", "wb"))
    sample_inf = pickle.load(open("ITA_sample_inf2_"+str(iter)+".p", "rb"))
    ...
    if low:
        pickle.dump(result.x, open("ITA_sample_Mu_R_Opt_low2_"+str(iter)+".p", "wb"))
        result.x = pickle.load(open("ITA_sample_Mu_R_Opt_low2_"+str(iter)+".p", "rb"))
    else:
        pickle.dump(result.x, open("ITA_sample_Mu_R_Opt_high2_"+str(iter)+".p", "wb"))
        result.x = pickle.load(open("ITA_sample_Mu_R_Opt_high2_"+str(iter)+".p", "rb"))
    ...
    Duration = 317
    gamma = 0.04788463
    sample = pickle.load(open("ITA_sample_Mu_R_Opt_low2_"+str(iter)+".p", "rb"))
    ...
    sample = pickle.load(open("ITA_sample_Mu_R_Opt_high2_"+str(iter)+".p", "rb"))
    ...
    Bulk = pickle.load(open("ITA_Bulk_Mu_R_Opt2.p", "rb"))
